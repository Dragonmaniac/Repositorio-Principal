...
$sql="select * from proyecto_inversion where municipio like 'Samuel Darío Maldonado' order by nro asc;";
...
$objPDF->Output("Listado_Municipio_Samuel_Darío_Maldonado.pdf","D");
?>