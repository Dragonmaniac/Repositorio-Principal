...
--
-- Servidor: localhost
-- Tiempo de generación: 21-02-2015 a las 02:10:16
...
('ki-2014-88-99', 5, 'EstaciÃ³n de Servicio Horizonte Grandioso', 'Tori Black', 414, 7539568, 'Ingeniera Petrolera', 'GobernaciÃ³n', 2015, 'Obra constituida con un terreno lo bastante elevado y seguro para soportar hasta 100 carros', 1, 'En EjecuciÃ³n', 1, 'Febrero', 2015, 'CÃ¡rdenas', 'Santa Ana', 'La Casa de Hanna', 7412590, 0, 0, 'Industrias Wayne', 'j-12.556.777.2', 'Jessica Redfox', '454.66.4456.', 'Franklin MÃ¡rquez', '787.63.48.66', 60, 7, 'Enero', 2015, 'SÃ­', 18, 'Abril', 2015, '100000'),
