...
$sql="select * from proyecto_inversion where municipio like 'Francisco de Miranda' order by nro asc;";
...
$objPDF->Output("Listado_Municipio_Francisco_de_Miranda.pdf","D");
?>