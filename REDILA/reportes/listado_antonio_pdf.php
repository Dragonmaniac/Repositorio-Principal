...
$sql="select * from proyecto_inversion where municipio like 'Antonio Rómulo Costa' order by nro asc;";
...
$objPDF->Output("Listado_Municipio_Antonio_Rómulo_Costa.pdf","D");
?>